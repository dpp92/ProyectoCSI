...
public class FragmentHomeAdmin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.admin_fragment_lista_expand_items, container, false);
        Log.e("Sesion", "Entramos a FragmentHome");
        context= container.getContext();

        lv = (ExpandableListView)rootView.findViewById(R.id.adminlistViewexp);
        accessWebService();
        hijos = new ArrayList<>();
        ...
        protected ArrayList<ExpandableListParent> doInBackground(String... strings) {
            ...
            try{
                ...
                for(int i=0;i<2;i++){
                    ...
                    hijos.add(new datosHijos(id,name,title,contenido));
